...
model = AutoModelForSequenceClassification.from_pretrained('google/muril-base-cased', num_labels=1)
...
model.save_pretrained('./murial')
tokenizer.save_pretrained('./murial')
