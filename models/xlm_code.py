...
# Modify the number of epochs based on how many were actually run
actual_epochs = len(train_losses)

# Adjust the epochs list for the actual number of epochs
...
model.save_pretrained('./XLM')
tokenizer.save_pretrained('./XLM')
